...
--
-- Table structure for table `staticflow`
--

CREATE TABLE IF NOT EXISTS `staticflow` (
  `id` int(11) DEFAULT NULL,
  `switch` varchar(50) DEFAULT NULL,
  `duration` varchar(50) DEFAULT NULL,
  `inport` varchar(50) DEFAULT NULL,
  `outport` varchar(50) DEFAULT NULL,
  `cookie` varchar(50) DEFAULT NULL,
  `nw_src` varchar(50) DEFAULT NULL,
  `nw_dst` varchar(50) DEFAULT NULL,
  `ip_proto` varchar(50) DEFAULT NULL,
  `tp_src` varchar(50) DEFAULT NULL,
  `tp_dst` varchar(50) DEFAULT NULL,
  `date_time` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `staticflow`
--

--
-- Table structure for table `staticflow_ids`
--

CREATE TABLE IF NOT EXISTS `staticflow_ids` (
  `id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `staticflow_ids`
--
